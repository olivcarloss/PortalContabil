-- Exclui o escritorio/CNPJ administrativos (clientes.interno, ver
-- 0012_escritorio_interno.sql) das views usadas pelos relatorios
-- Sintetico/Analitico. Na pratica nunca havera conciliacoes/lancamentos
-- reais contra esse escritorio, mas o filtro fica explicito por seguranca.
